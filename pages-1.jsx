...
const PageOverview = ({ filters, setFilters, onOpenFilters, statusFilter, drilldown, setDrilldown }) => {
...
const PageIndicators = ({ statusFilter, drilldown, setDrilldown }) => {
  const B = window.getBit(statusFilter, drilldown);
...
const PageReceita = ({ filters, setFilters, onOpenFilters, statusFilter, drilldown, setDrilldown }) => {
  const B = window.getBit(statusFilter, drilldown);
...
const PageDespesa = ({ filters, setFilters, onOpenFilters, statusFilter, drilldown, setDrilldown }) => {
  const B = window.getBit(statusFilter, drilldown);
  const totalDespesa = B.TOTAL_DESPESA;
